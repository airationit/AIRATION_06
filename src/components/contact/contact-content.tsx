      ...
      <section className="mx-auto w-full max-w-6xl px-6 pb-24">
        <div className="grid gap-12 lg:grid-cols-12 lg:items-start">
          ...
          >
                ...
                return (
                  <a
                    ...
                    {...(channel.href.startsWith("http")
                      ...
                      : {})}
                    className="group flex items-start gap-4 rounded-2xl border border-border/60 bg-background/60 p-4 transition-all duration-300 hover:border-blue-500/40 hover:bg-blue-50/30 dark:hover:bg-blue-950/20"
                  >
                    <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-blue-500/10 text-blue-600 dark:text-blue-400 transition-colors group-hover:bg-blue-600 group-hover:text-white">
                    ...
                    <div>
                      ...
                      <span className="mt-0.5 block text-base font-semibold text-foreground group-hover:text-blue-600 dark:group-hover:text-blue-400">
                        {channel.value}
                      </span>
              ...
              <div className="mt-4 grid gap-4 sm:grid-cols-2 lg:grid-cols-1">
                {SUPPORT_CATEGORIES.map((cat, idx) => {
                  ...
                  return (
                    <div
                      key={idx}
                      className="flex items-start gap-3 rounded-xl border border-border/40 bg-background/40 p-3.5"
                    >
            ...
            {/* App Download Callout with Scan to Download */}
            <div className="rounded-2xl border border-blue-500/20 bg-gradient-to-br from-blue-50/60 via-indigo-50/40 to-transparent p-5 dark:from-blue-950/40 dark:via-indigo-950/20">
              <div className="flex items-center gap-2 text-blue-600 dark:text-blue-400 font-semibold text-sm">
                <Sparkles className="h-4 w-4" />
                <span>Scan to download the app</span>
              </div>
              <p className="mt-1 text-xs text-muted-foreground">
                India's 1st swipe-based hiring platform. Available on Android & iOS soon.
              </p>
              ...
              <div className="mt-4 flex flex-wrap items-center gap-3">
                ...
                <a
                  ...
                  className="group inline-flex items-center gap-2.5 rounded-xl border border-blue-600/30 bg-blue-600 px-4 py-2.5 text-white shadow-sm transition-all hover:bg-blue-700"
                >
                ...
                <div className="inline-flex items-center gap-2 rounded-xl border border-border/60 bg-background/60 px-3.5 py-2.5 text-left opacity-80">
                ...
                <form onSubmit={handleSubmit} className="space-y-6" noValidate>
                        ...
                        <button
                          ...
                          className={`rounded-xl border py-2.5 px-3 text-xs font-semibold transition-all ${
                            form.userType === type.id
                              ...
                              : "border-border/80 bg-background/60 text-muted-foreground hover:border-blue-500/40 hover:text-foreground"
                          }`}
                        >
                          {type.label}
                        </button>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full rounded-xl border border-border/80 bg-background px-4 py-3 text-sm text-foreground outline-none transition-all placeholder:text-muted-foreground/60 focus:border-blue-600 focus:ring-2 focus:ring-blue-500/20 resize-y min-h-[120px]"
                    />
                  </div>
                  ...
                  <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between pt-2">
                    ...
                    <button
                      type="submit"
                      disabled={submitting}
                      className="inline-flex h-12 items-center justify-center gap-2 rounded-xl bg-blue-600 px-7 text-sm font-semibold text-white transition-all hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500/40 disabled:opacity-60"
                    >
                      {submitting ? (
                        <span>Sending...</span>
                      ) : (
