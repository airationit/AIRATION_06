...
import {
  ...
  Building, ScrollText, MapPin, PhoneCall
} from "lucide-react";
...
export function MobilePrivacyPolicyContent() {
  ...
  const copyEmailToClipboard = () => {
    if (typeof navigator !== "undefined" && navigator.clipboard) { navigator.clipboard.writeText("hello@hirance.com"); }
    setCopiedEmail(true);
  ...
  const definitionsTable = [
    ...
    { term: '"Data Fiduciary"', def: 'Hirance Private Limited, in its capacity as the entity that determines the purpose and means of processing your Personal Data, as defined under the DPDP Act, 2023.' },
    { term: '"Data Principal"', def: 'You, the candidate or job seeker whose Personal Data is being processed by Hirance.' },
    ...
    { term: '"Data Processor"', def: 'Any third party engaged by Hirance to process Personal Data on Hirance’s behalf, including cloud infrastructure providers, payment gateways, KYC verification vendors, and analytics partners.' },
    { term: '"Platform"', def: 'The website, mobile application, APIs, and all digital services operated by Hirance Private Limited.' },
    { term: '"Services"', def: 'All services offered by Hirance to candidates through the Platform, including job matching, profile management, employer communication, identity verification, and related features.' },
  ...
  const catA = [
    ...
    { cat: "Why we process it", details: "To perform the contract between you and Hirance for the provision of candidate services; to operate the candidate account; and to facilitate the job-seeking process. Phone and email are also used for two-factor authentication and account security." },
    { cat: "Legal basis", details: "Performance of a contract (Article 6(1)(b) equivalent under DPDP Act, 2023); legitimate interests of Hirance in operating a secure and functional recruitment platform." },
  ...
  const catB = [
    ...
    { cat: "Legal basis", details: "Performance of a contract; legitimate interests of Hirance in providing an effective recruitment platform; your explicit consent where applicable." },
  ...
  const catC = [
    ...
    { cat: "How we collect it", details: "Directly from you when you opt into identity verification or when verification is required to access certain features. Identity document uploads and selfie/liveness checks are processed through Hirance’s authorised KYC verification partner." },
    ...
    { cat: "Why we process it", details: "Fraud prevention and platform security constitute legitimate interests of Hirance. Processing of government-issued ID and biometric data for identity verification purposes is subject to your explicit prior consent, which may be withdrawn at any time (with the consequence that verified status will be revoked)." },
  ...
  const catD = [
    ...
    { cat: "How we collect it", details: "Collected at the time of initiating a payment transaction through the Platform’s integrated payment interface. Full card details are transmitted directly to Hirance’s PCI-DSS compliant third-party payment gateway and are never stored on Hirance’s servers." },
  ...
  const catE = [
    ...
    { cat: "Why we process it", details: "Legitimate interests of Hirance in operating a secure, functional, and optimised digital platform. Where processing involves targeted analytics or profiling, Hirance relies on your consent obtained via the Cookie Consent mechanism." },
  ...
  const catF = [
    ...
    { cat: "Why we process it", details: "Legitimate interests of Hirance in maintaining a safe, functional communication environment; performance of a support contract; legal obligations to retain records of certain communications." },
        ...
        <section className="relative bg-gradient-to-br from-blue-900 via-indigo-900 to-slate-900 text-white pt-24 pb-16 px-4 sm:px-6 sm:pt-28 overflow-hidden">
          ...
          <div className="max-w-5xl mx-auto relative z-10 text-center">
            ...
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-blue-500/20 border border-blue-400/30 text-blue-300 text-xs font-semibold uppercase tracking-wider mb-5">
              ...
              <span>Hirance Private Limited · Official Privacy Policy</span>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="p-4 rounded-2xl bg-indigo-50/70 border border-indigo-100 flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-600 leading-relaxed">
                    Hirance Private Limited, 8/4, Sector-4, Jankipuram, Lucknow – 226021, UP, India.
                  </p>
                </div>
              </div>
              ...
              <div className="p-4 rounded-2xl bg-amber-50/70 border border-amber-200 flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-600 leading-relaxed">
                    Official email: <a href="mailto:hello@hirance.com" className="text-blue-600 font-bold hover:underline">hello@hirance.com</a>
                  </p>
                </div>
              </div>
            ...
            <div className="flex-1 space-y-10 min-w-0">
              ...
              <div id="intro" className="bg-white p-6 sm:p-8 rounded-3xl border border-slate-200 shadow-xs space-y-5 scroll-mt-24">
                ...
                <div className="flex items-center gap-3 border-b border-slate-100 pb-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500">Hirance Private Limited · Last updated: 24.03.2026 | Version 1.0</p>
                  </div>
                </div>

                <div className="prose prose-slate max-w-none text-xs sm:text-sm text-slate-700 space-y-4 leading-relaxed">
                  <p>
                    This Privacy Policy (&quot;Privacy Policy&quot;) is published by Hirance Private Limited, a company incorporated under the Companies Act, 2013, with its registered office at 8/4, Sector-4, Jankipuram, Lucknow – 226021, Uttar Pradesh, India (&quot;Hirance&quot;, &quot;we&quot;, &quot;us&quot;, or &quot;our&quot;). This Privacy Policy governs the collection, use, storage, processing, disclosure, and protection of Personal Data submitted by candidates and job seekers (&quot;you&quot;, &quot;your&quot;, or &quot;User&quot;) who access or use our Platform and Services.
                  </p>
                  <p>
              ...
              <div id="section-1" className="bg-white p-6 sm:p-8 rounded-3xl border border-slate-200 shadow-xs space-y-5 scroll-mt-24">
                ...
                <p className="text-xs sm:text-sm text-slate-700 leading-relaxed m-0">
                  The following terms shall have the meanings set out below and shall apply throughout this Privacy Policy and all related policies of Hirance.
                </p>
              ...
              <div id="section-2" className="bg-white p-6 sm:p-8 rounded-3xl border border-slate-200 shadow-xs space-y-5 scroll-mt-24">
                ...
                <p className="text-xs sm:text-sm text-slate-700 leading-relaxed m-0">
                  Hirance is committed to maintaining the highest standards of data privacy and security for all candidates using its Platform. The objective of this Privacy Policy is to:
                </p>

                <ul className="space-y-2 text-xs sm:text-sm text-slate-700 list-disc ml-5">
                  <li>Provide you with a clear, transparent, and comprehensive understanding of how your Personal Data is collected, used, stored, and shared by Hirance;</li>
                  ...
                  <li>Establish your rights as a Data Principal and Hirance’s obligations as a Data Fiduciary;</li>
                  <li>Describe the technical and organizational safeguards implemented by Hirance to protect your Personal Data against loss, misuse, unauthorized access, disclosure, alteration, and destruction;</li>
                  <li>Set out the legal bases upon which Hirance processes each category of your Personal Data.</li>
                </ul>
                ...
                <div className="space-y-3 pt-4 border-t border-slate-100">
                  ...
                  <div className="p-4 rounded-2xl bg-amber-50 border border-amber-200 flex flex-col sm:flex-row gap-3 items-start">
                    ...
                    <p className="text-xs text-slate-800 leading-relaxed m-0">
                      Identity documents (Aadhaar, PAN, Passport) and biometric data (selfie/liveness photos) constitute Sensitive Personal Data under the IT (SPDI) Rules, 2011, and Sensitive Data under the DPDP Act, 2023. This data is processed only with your explicit, freely given, informed, and specific consent. You may withdraw consent at any time by contacting hello@hirance.com, which will result in the revocation of your verified status on the Platform.
                    </p>
                  </div>
                </div>
              ...
              <div id="section-4" className="bg-white p-6 sm:p-8 rounded-3xl border border-slate-200 shadow-xs space-y-5 scroll-mt-24">
                ...
                <p className="text-xs sm:text-sm text-slate-700 leading-relaxed m-0">
                  Hirance processes your Personal Data only where a valid legal basis exists under applicable Indian law, including the DPDP Act, 2023. The primary legal bases relied upon by Hirance are:
                </p>
                ...
                <div className="space-y-3 text-xs sm:text-sm text-slate-700 leading-relaxed">
                  ...
                  <p>
                    <strong>Performance of a Contract:</strong> Where processing is necessary to perform the candidate services agreement between you and Hirance, including account creation, job matching, profile management, and payment processing for premium services.
                  </p>
                  <p>
                    <strong>Legitimate Interests:</strong> Where processing is necessary for Hirance’s legitimate business interests, provided such interests are not overridden by your fundamental rights and freedoms. Legitimate interests relied upon include platform security, fraud prevention, product improvement, and analytics. Where Hirance relies on legitimate interests, a Legitimate Interests Assessment (LIA) has been conducted.
                  </p>
                  <p>
                  ...
                  <p>
                    <strong>Vital Interests:</strong> In exceptional circumstances, Hirance may process Personal Data to protect the vital interests of you or another natural person, including in life-threatening situations or emergencies.
                  </p>
                </div>
              </div>
              ...
              <div id="section-5" className="bg-white p-6 sm:p-8 rounded-3xl border border-slate-200 shadow-xs space-y-5 scroll-mt-24">
                ...
                <p className="text-xs sm:text-sm text-slate-700 leading-relaxed m-0">
                  In addition to the specific uses described for each data category in Section 3, Hirance uses Personal Data collected from candidates for the following overarching purposes:
                </p>

                <div className="space-y-3 text-xs sm:text-sm text-slate-700 leading-relaxed">
                  <p>
                    <strong>Job Matching and Personalised Recommendations:</strong> Hirance’s proprietary AI-based matching engine analyses your professional profile, skills, experience, location preferences, and behavioural signals to generate ranked lists of relevant job opportunities. The matching algorithm uses statistical and machine-learning models trained on historical recruitment outcomes on the Platform. Candidates may opt out of algorithmic profiling for job matching by contacting hello@hirance.com, though this will significantly reduce the relevance of job recommendations.
                  </p>
                  <p>
              ...
              <div id="section-6" className="bg-white p-6 sm:p-8 rounded-3xl border border-slate-200 shadow-xs space-y-5 scroll-mt-24">
                ...
                <p className="text-xs sm:text-sm text-slate-700 leading-relaxed m-0">
                  Hirance uses automated processing, including machine-learning-based profiling, to facilitate job matching and candidate ranking. This involves creating a candidate ‘match score’ that determines the order in which your profile appears in employer search results and the job recommendations you receive.
                </p>

                <p className="text-xs sm:text-sm text-slate-700 leading-relaxed m-0">
                  Hirance acknowledges that automated decision-making may have a significant impact on your employment opportunities on the Platform. Accordingly, Hirance provides the following safeguards:
                </p>
                ...
                <ul className="space-y-2 text-xs sm:text-sm text-slate-700 list-disc ml-5 leading-relaxed">
                  ...
                  <li>You may contact hello@hirance.com to request an explanation of the logic underlying the matching score assigned to your profile;</li>
              ...
              <div id="section-7" className="bg-white p-6 sm:p-8 rounded-3xl border border-slate-200 shadow-xs space-y-6 scroll-mt-24">
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-xs sm:text-sm text-slate-700 leading-relaxed m-0">
                    Hirance provides candidates with granular controls over the visibility of their profile and the specific data elements within it. The default visibility settings and available options are as follows:
                  </p>
                  <ul className="space-y-2 text-xs sm:text-sm text-slate-700 list-disc ml-5 leading-relaxed">
                ...
                <div className="space-y-3 pt-4 border-t border-slate-100">
                  ...
                  <ul className="space-y-2 text-xs sm:text-sm text-slate-700 list-disc ml-5 leading-relaxed">
                    ...
                    <li>Request a machine-readable export of all Personal Data held by Hirance in relation to your account (data portability);</li>
                  ...
                  <p className="text-xs sm:text-sm text-slate-700 leading-relaxed pt-2">
                    To exercise any of the above rights, submit a request to hello@hirance.com with the subject line ‘Data Rights Request – [Your Full Name]’. Hirance will acknowledge your request within 72 hours and respond substantively within 15 (fifteen) business days, subject to verification of your identity.
                  </p>
                </div>
              </div>
              ...
              <div id="section-8" className="bg-white p-6 sm:p-8 rounded-3xl border border-slate-200 shadow-xs space-y-5 scroll-mt-24">
                ...
                <p className="text-xs sm:text-sm text-slate-700 leading-relaxed m-0">
                  All payment transactions on the Platform are processed exclusively through Hirance’s authorised third-party payment gateway partners, which are certified to the Payment Card Industry Data Security Standard (PCI-DSS). Hirance does not process, store, or have access to your full debit or credit card number, CVV/CVC code, net banking credentials, or UPI PIN.
                </p>

                <p className="text-xs sm:text-sm text-slate-700 leading-relaxed m-0">
                  When you initiate a payment, your payment instrument details are transmitted directly to the payment gateway using Transport Layer Security (TLS) encryption. Hirance receives only a tokenised transaction reference and the transaction status (success/failure), which are stored in Hirance’s encrypted financial records.
                </p>
                ...
                <p className="text-xs sm:text-sm text-slate-700 leading-relaxed">
                  Refunds, where applicable, are processed in accordance with Hirance’s Refund Policy as published on the Platform. Refund requests must be submitted within the period specified in the Refund Policy and will be credited to the original payment instrument within 7 to 10 business days of approval.
                </p>
                ...
                <div className="p-4 rounded-2xl bg-indigo-50 border border-indigo-200 flex flex-col sm:flex-row gap-3 items-start">
                  ...
                  <p className="text-xs text-indigo-950 leading-relaxed m-0">
                    Hirance’s payment infrastructure is integrated exclusively with PCI-DSS Level 1 certified payment gateways. Card data is never transmitted to or stored on Hirance’s servers. All payment API communications use TLS 1.2 or higher encryption.
                  </p>
                </div>
              </div>
              ...
              <div id="section-9" className="bg-white p-6 sm:p-8 rounded-3xl border border-slate-200 shadow-xs space-y-6 scroll-mt-24">
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-xs sm:text-sm text-slate-700 leading-relaxed m-0">
                    All identity documents submitted by candidates for KYC or verification purposes are treated as Sensitive Personal Data and are subject to the highest level of security controls applied by Hirance. Specifically:
                  </p>
                  <ul className="space-y-2 text-xs sm:text-sm text-slate-700 list-disc ml-5 leading-relaxed">
                    <li>Identity documents are transmitted to Hirance’s KYC verification partner using AES-256 encrypted channels;</li>
                    ...
                    <li>Hirance’s KYC partners are bound by contractual data processing agreements requiring equivalent security standards and prohibiting secondary use of your documents;</li>
                ...
                <div className="space-y-3 pt-4 border-t border-slate-100">
                  ...
                  <ul className="space-y-2 text-xs sm:text-sm text-slate-700 list-disc ml-5 leading-relaxed">
                    ...
                    <li>Deleted from the KYC partner’s active systems within 30 days of completed verification, with only the verification result (pass/fail) and a reference token retained by Hirance;</li>
              ...
              <div id="section-10" className="bg-white p-6 sm:p-8 rounded-3xl border border-slate-200 shadow-xs space-y-6 scroll-mt-24">
                ...
                <div className="space-y-4 text-xs sm:text-sm text-slate-700 leading-relaxed">
                  <div>
                    ...
                    <p className="m-0">
                      Your candidate profile information is made available to employers who are registered on the Platform and have passed Hirance’s employer verification process. The specific data elements shared with employers depend on your visibility settings, as described in Section 7. Hirance does not share your Sensitive Personal Data, identity documents, or financial information with employers.
                    </p>
                  </div>
                  ...
                  <div className="pt-3 border-t border-slate-100">
                    ...
                    <p className="mb-3">
                      Hirance engages the following categories of third-party Data Processors who may access certain elements of your Personal Data on Hirance’s behalf, strictly for the purposes described in this Privacy Policy:
                    </p>
                    <ul className="space-y-2 list-disc ml-5">
                      ...
                      <li><strong>AI and Machine Learning Infrastructure:</strong> Third-party ML platforms used in the development and operation of Hirance’s job matching algorithms, subject to strict data anonymisation requirements.</li>
                    </ul>
                    <p className="mt-3 m-0">
                      All Data Processors are bound by Data Processing Agreements (DPAs) that impose obligations equivalent to or stricter than those applicable to Hirance under the DPDP Act, 2023. Hirance remains responsible for ensuring that its Data Processors comply with these obligations.
                    </p>
                  </div>
                  ...
                  <div className="pt-3 border-t border-slate-100">
                    ...
                    <p className="mb-2">
                      Hirance may disclose your Personal Data to law enforcement agencies, regulatory authorities, courts, or government bodies in the following circumstances:
                    </p>
                    <ul className="space-y-1.5 list-disc ml-5">
                      ...
                      <li>Where necessary to protect the rights, property, or safety of Hirance, its employees, its Users, or the public;</li>
                      <li>In connection with any legal proceedings, investigation, or regulatory enquiry to which Hirance is a party or subject.</li>
                    </ul>
                    <p className="mt-2 m-0">
                      Hirance will, to the extent permitted by law, notify you of any such disclosure before it is made or as promptly thereafter as circumstances permit.
                    </p>
                  </div>
                  ...
                  <div className="pt-3 border-t border-slate-100 space-y-2">
                    ...
                    <p className="m-0">
                      Hirance primarily stores and processes your Personal Data within India. To the extent that any Personal Data is transferred to servers or processors located outside India (for example, in connection with the use of internationally hosted cloud services or analytics platforms), Hirance shall ensure that such transfers are effected in accordance with the provisions of the DPDP Act, 2023 and any rules or notifications issued by the Central Government specifying approved jurisdictions for cross-border data transfers.
                    </p>
                    <p className="m-0">
                      Hirance implements appropriate safeguards for cross-border transfers, including standard contractual clauses, adequacy determinations, or binding corporate rules, as applicable. Users may request information about cross-border transfer safeguards by contacting hello@hirance.com.
                    </p>
                  </div>
                  ...
                  <div className="pt-3 border-t border-slate-100">
                    ...
                    <p className="m-0">
                      Hirance does not sell, rent, or otherwise commercially exploit your Personal Data to third parties. Personal Data is shared only as described in this Section and only to the extent necessary for the stated purposes.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div id="section-11" className="bg-white p-6 sm:p-8 rounded-3xl border border-slate-200 shadow-xs space-y-5 scroll-mt-24">
                ...
                <div className="space-y-4 text-xs sm:text-sm text-slate-700 leading-relaxed">
                  <div>
                    ...
                    <p className="mb-2">
                      When you access the Platform, Hirance and its authorised third-party partners may place the following categories of cookies and similar tracking technologies on your device:
                    </p>
                    <ul className="space-y-2 list-disc ml-5">
                      ...
                      <li><strong>Targeting and Marketing Cookies:</strong> Used by Hirance and its advertising partners to deliver relevant job advertisements and content based on your browsing behaviour, both on and off the Platform. These are subject to your prior consent.</li>
                    </ul>
                  </div>
                  ...
                  <div className="pt-3 border-t border-slate-100">
                    ...
                    <p className="m-0">
                      The Platform does not currently respond to browser ‘Do Not Track’ (DNT) signals. Hirance is monitoring developments in DNT standards and will update this policy if a widely accepted standard is implemented.
                    </p>
                  </div>
              ...
              <div id="section-12" className="bg-white p-6 sm:p-8 rounded-3xl border border-slate-200 shadow-xs space-y-5 scroll-mt-24">
                ...
                <p className="text-xs sm:text-sm text-slate-700 leading-relaxed m-0">
                  Hirance is committed to maintaining a safe, trustworthy, and fraud-free environment for candidates. The following technical and procedural safeguards are in place:
                </p>

                <ul className="space-y-2 text-xs sm:text-sm text-slate-700 list-disc ml-5 leading-relaxed">
                  <li><strong>AI-Based Anomaly Detection:</strong> Hirance’s security system continuously monitors login patterns, application submission rates, and behavioural signals to detect accounts exhibiting bot-like or fraudulent behaviour. Detected anomalies trigger automated temporary holds pending manual security review.</li>
                  ...
                  <li><strong>Report and Block System:</strong> Candidates may report suspicious employers, job postings, or communications directly through the Platform interface. Reports are reviewed by Hirance’s Trust and Safety team within 48 hours.</li>
                  <li><strong>Employer Verification:</strong> All employers are required to complete Hirance’s employer verification process before being permitted to contact candidates or access full candidate profiles. Unverified employers have restricted access to candidate data.</li>
                  <li><strong>Phishing and Impersonation Monitoring:</strong> Hirance monitors for external websites, social media accounts, or email campaigns that impersonate Hirance or the Platform and takes takedown action where possible.</li>
                </ul>
              </div>
              ...
              <div id="section-13" className="bg-white p-6 sm:p-8 rounded-3xl border border-slate-200 shadow-xs space-y-6 scroll-mt-24">
                ...
                <div className="space-y-2 text-xs sm:text-sm text-slate-700 leading-relaxed">
                  ...
                  <p className="m-0">
                    Hirance retains Personal Data only for as long as is necessary to fulfil the purpose for which it was collected, or as required by applicable law. Hirance’s data retention framework is based on the following principles:
                  </p>
                ...
                <div className="space-y-2 pt-3 border-t border-slate-100 text-xs sm:text-sm text-slate-700 leading-relaxed">
                  ...
                  <p className="m-0">
                    The following retention schedule applies to the categories of Personal Data processed by Hirance:
                  </p>
                  <ul className="space-y-1.5 list-disc ml-5">
                ...
                <div className="space-y-2 pt-3 border-t border-slate-100 text-xs sm:text-sm text-slate-700 leading-relaxed">
                  ...
                  <p className="m-0">
                    You may request deletion of your account and associated Personal Data at any time by submitting a request to hello@hirance.com or through the account deletion function in the Platform’s settings. Hirance will process your deletion request within 30 (thirty) days, subject to the following qualifications:
                  </p>
                  <ul className="space-y-1.5 list-disc ml-5">
                    <li>Hirance may retain Personal Data that is required to be retained under applicable law notwithstanding your erasure request;</li>
                    ...
                    <li>Hirance may retain data necessary to defend against legal claims, resolve disputes, or comply with ongoing regulatory obligations;</li>
                    <li>Upon completion of the erasure process, Hirance will provide written confirmation that your Personal Data has been deleted.</li>
                  </ul>
                </div>
              </div>
              ...
              <div id="section-14" className="bg-white p-6 sm:p-8 rounded-3xl border border-slate-200 shadow-xs space-y-5 scroll-mt-24">
                ...
                <p className="text-xs sm:text-sm text-slate-700 leading-relaxed m-0">
                  As a Data Principal under the Digital Personal Data Protection Act, 2023, you are entitled to the following rights with respect to your Personal Data processed by Hirance. These rights are in addition to any other rights you may have under applicable Indian law.
                </p>

                <div className="space-y-3 text-xs sm:text-sm text-slate-700 leading-relaxed">
                  <p>
                    <strong>Right of Access (Section 11, DPDP Act):</strong> You have the right to obtain a summary of the Personal Data held by Hirance about you, the purposes for which it is being processed, and a list of all Data Processors and third parties with whom your Personal Data has been shared.
                  </p>
                  <p>
                  ...
                  <p>
                    <strong>Right to Grievance Redressal (Section 13, DPDP Act):</strong> You have the right to have your grievances about the processing of your Personal Data addressed by Hirance’s designated Grievance Officer within the timeframes specified by law.
                  </p>
                  <p>
                  ...
                  <p>
                    To exercise any of the above rights, submit a written request to hello@hirance.com with the subject line ‘DPDP Rights Request’ accompanied by adequate identity verification. Hirance will acknowledge your request within 72 hours and respond within 15 (fifteen) business days. Requests that are manifestly unfounded or excessive may be subject to an administrative fee not exceeding a reasonable amount as prescribed by applicable regulations.
                  </p>
                </div>
                ...
                <div className="p-4 rounded-2xl bg-purple-50 border border-purple-200 flex flex-col sm:flex-row gap-3 items-start">
                  ...
                  <p className="text-xs text-purple-950 leading-relaxed m-0 font-medium">
                    If you are not satisfied with Hirance’s response to your rights request or grievance, you have the right to escalate your complaint to the Data Protection Board of India, once constituted under the Digital Personal Data Protection Act, 2023.
                  </p>
                </div>
              </div>
              ...
              <div id="section-15" className="bg-white p-6 sm:p-8 rounded-3xl border border-slate-200 shadow-xs space-y-6 scroll-mt-24">
                ...
                <div className="space-y-4 text-xs sm:text-sm text-slate-700 leading-relaxed">
                  <div>
                    ...
                    <p className="mb-2">
                      Hirance implements the following technical security measures to protect your Personal Data against unauthorised access, disclosure, alteration, loss, or destruction:
                    </p>
                    <ul className="space-y-2 list-disc ml-5">
                      <li><strong>Encryption in Transit:</strong> All communications between your device and Hirance’s servers are encrypted using Transport Layer Security (TLS 1.2 or higher). HTTPS is enforced across all Platform endpoints.</li>
                      <li><strong>Encryption at Rest:</strong> Personal Data stored on Hirance’s databases and cloud infrastructure is encrypted at rest using AES-256 encryption. Sensitive Personal Data (identity documents, biometric data, financial records) is subject to additional field-level encryption.</li>
                      ...
                      <li><strong>Penetration Testing and Vulnerability Assessments:</strong> Hirance conducts regular third-party penetration tests and internal vulnerability assessments of its systems, networks, and application code to identify and remediate security weaknesses.</li>
                      <li><strong>Intrusion Detection and Prevention:</strong> Hirance deploys network-level and application-level intrusion detection and prevention systems (IDS/IPS) to monitor for and respond to suspicious activity in real time.</li>
                      <li><strong>Data Masking and Tokenisation:</strong> Contact details (phone numbers, email addresses) are masked in employer-facing interfaces and tokenised in Hirance’s internal systems to reduce the risk of exposure in the event of a security incident.</li>
                    </ul>
                  </div>
                  ...
                  <div className="pt-3 border-t border-slate-100">
                    ...
                    <p className="mb-2">
                      Hirance implements the following organisational measures to support the security of Personal Data:
                    </p>
                    <ul className="space-y-1.5 list-disc ml-5">
                      <li><strong>Data Protection Training:</strong> All Hirance employees with access to Personal Data receive mandatory data protection and security awareness training on an annual basis;</li>
                      ...
                      <li><strong>Internal Data Protection Policy:</strong> Hirance maintains an internal Data Protection Policy governing the handling of Personal Data by its employees and contractors;</li>
                      <li><strong>Incident Response Plan:</strong> Hirance maintains a documented Data Breach Incident Response Plan specifying procedures for detection, containment, assessment, notification, and remediation of data security incidents;</li>
                      <li><strong>Data Protection Officer:</strong> Hirance has designated a Data Protection Point of Contact responsible for overseeing compliance with this Privacy Policy and applicable data protection law.</li>
                    </ul>
                  </div>
                  ...
                  <div className="p-4 rounded-2xl bg-amber-50 border border-amber-200 flex flex-col sm:flex-row gap-3 items-start">
                    ...
                    <p className="text-xs text-slate-800 leading-relaxed m-0 font-medium">
                      Notwithstanding the security measures described above, no system of data transmission or storage can be guaranteed to be 100% secure. Hirance cannot guarantee the absolute security of your Personal Data against all threats. You are advised to use strong, unique passwords for your Hirance account and to enable MFA where available.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div id="section-17" className="bg-white p-6 sm:p-8 rounded-3xl border border-slate-200 shadow-xs space-y-4 scroll-mt-24">
                ...
                <p className="text-xs sm:text-sm text-slate-700 leading-relaxed m-0">
                  Hirance reserves the right to update, modify, or replace this Privacy Policy at any time to reflect changes in applicable law, Platform features, data processing practices, or business operations. The updated Privacy Policy will be published on the Platform with the revised effective date.
                </p>

                <p className="text-xs sm:text-sm text-slate-700 leading-relaxed m-0">
                  Where changes are material (i.e., where they significantly affect your rights, the purposes for which your data is processed, or the parties with whom your data is shared), Hirance will provide advance notice of at least 14 (fourteen) days through a prominent in-Platform notification and, where possible, by email to your registered address.
                </p>
              ...
              <div id="section-18" className="bg-white p-6 sm:p-8 rounded-3xl border border-slate-200 shadow-xs space-y-6 scroll-mt-24">
                ...
                <p className="text-xs sm:text-sm text-slate-700 leading-relaxed m-0">
                  For any questions, concerns, complaints, or requests relating to this Privacy Policy or the processing of your Personal Data by Hirance, you may contact Hirance’s designated Grievance Officer at the following coordinates:
                </p>
                ...
                <div className="p-6 rounded-3xl bg-gradient-to-br from-blue-50 via-indigo-50 to-white border border-blue-200 space-y-4">
                  <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                    <div>
                      ...
                      <p className="text-xs font-semibold text-slate-700 m-0">Hirance Private Limited</p>
                    </div>
                  ...
                  <div className="space-y-2 text-xs sm:text-sm text-slate-700 pt-2 border-t border-blue-100">
                    <p className="flex items-center gap-2 m-0">
                      ...
                      <strong>Email:</strong> <a href="mailto:hello@hirance.com" className="text-blue-600 font-bold hover:underline">hello@hirance.com</a>
                    </p>
                    <p className="flex items-center gap-2 m-0">
                  ...
                  <div className="p-4 rounded-2xl bg-white border border-blue-200 flex flex-col sm:flex-row gap-3 items-start">
                    ...
                    <p className="text-xs text-slate-700 leading-relaxed m-0 font-medium">
                      Hirance’s Grievance Officer will acknowledge all complaints and requests within 72 hours of receipt and provide a substantive response within 15 (fifteen) business days, in accordance with the requirements of the Digital Personal Data Protection Act, 2023, and the IT (Intermediary Guidelines and Digital Media Ethics Code) Rules, 2021.
                    </p>
                  </div>
                ...
                <div className="p-4 rounded-2xl bg-slate-100 text-center text-xs text-slate-600 font-medium">
                  This Privacy Policy was last reviewed and approved by Hirance Private Limited on 24.03.2026.
                </div>
