...
export const metadata: Metadata = {
  ...
  description:
    "Read verified reviews and feedback from job seekers and employers using Hirance—the next-generation swipe-based hiring platform. Discover how fast hiring happens.",
  keywords: [
    "Hirance reviews",
